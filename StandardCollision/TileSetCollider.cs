...
{
    //Note: The tileset will not change sizes when you change the size of the tileSetCollider's rect.
    //    : Call TileSetDraw() in the draw method.
    public abstract class TileSetCollider : ICollider
    {
        //IObject:
        public void HiddenUpdate() { Update(); }  //Nothing here for a tileSetCollider.
        ...
        public abstract Rectangle Rect { get; set; }  //Position and collider of the tileSetCollider.
        ...
        //IColllider:
        public abstract bool isColliderActive { get; set; }  //Does the collider function?
        ...
        /// </summary>
        /// <param name="offSet">The amount of pixels the texture is outside the collider-rectangle.</param>
